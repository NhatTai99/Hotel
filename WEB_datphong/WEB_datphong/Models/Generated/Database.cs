...
//     Connection String:      `Data Source=NHATTAI\SQLEXPRESS;Initial Catalog=hotelOnline;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace HotelConection
{
    ...
    public partial class TINTUC : HotelConectionDB.Record<TINTUC>  
    {
		...
		[Column] public string MaTinTuc { get; set; }





		[Column] public string TenTinTuc { get; set; }
		...
		[Column] public string Anh { get; set; }
